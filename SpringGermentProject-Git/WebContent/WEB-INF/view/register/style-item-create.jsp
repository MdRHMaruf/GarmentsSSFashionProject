...
<div class="page-wrapper">
	<div class="content container-fluid">
		<div class="alert alert-success alert-dismissible fade show"
			style="display: none;">
			<p id="successAlert" class="mb-0"><strong>Success!</strong> Style Item Name Save Successfully..</p>
		</div>
		<div class="alert alert-warning alert-dismissible fade show"
			style="display: none;">
			<p id="warningAlert" class="mb-0"><strong>Warning!</strong> Style Item Name Empty.Please Enter Style Item Name...</p>
		</div>
								...
								<tbody id="dataList">
									<c:forEach items="${styleItemList}" var="styleItem"
										...
										<tr>
											...
											<td><i class="fa fa-edit" onclick="setData(${styleItem.styleItemId})"> </i></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
...
<script
	src="${pageContext.request.contextPath}/assets/js/register/style-item-create.js"></script>