...
<div class="page-wrapper">
	...
	<input type="hidden" id="type" value="<%=ProductionType.IRON_PASS.getType()%>">
	<input type="hidden" id="fpType" value="<%=ProductionType.FINISHING_PASS.getType()%>">
	<input type="hidden" id="passType" value="<%=ProductionType.IRON_PASS.getType()%>">
			<input type="hidden" id="rejectType" value="<%=ProductionType.IRON_REJECT.getType()%>">
	<input type="hidden" id="itemAutoId" value="0">

	<div class="card-box">
		<header class="">
			<h5 class="text-center" style="display: inline;">Iron Production</h5>
			<button type="button" class="btn btn-outline-dark btn-sm"
				data-toggle="modal" data-target="#exampleModal">
				<i class="fa fa-search"></i>
			</button>
			<button type="button" class="btn btn-outline-dark btn-sm"
				data-toggle="modal" data-target="#ironListModal">
				<i class="fa fa-search"></i>Iron List
			</button>
		</header>
		<hr class="my-1">
		<div class="row">
...
<div class="modal fade" id="ironListModal" tabindex="-1" role="dialog"
	aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<div class="input-group">
					<input id="searchIron" type="text" class="form-control"
						placeholder="Search Iron Production"
						aria-label="Recipient's username" aria-describedby="basic-addon2">
					<div class="input-group-append">
						<span class="input-group-text"><i class="fa fa-search"></i></span>
					</div>
...
<script
	src="${pageContext.request.contextPath}/assets/js/production/iron_production.js"></script>
