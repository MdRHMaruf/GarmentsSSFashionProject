...
<div class="page-wrapper">
	...
	<input type="hidden" id="type" value="<%=ProductionType.IRON_LAYOUT.getType()%>">
	<input type="hidden" id="itemAutoId" value="0">

	<div class="card-box">
		<header class="">
			<h5 class="text-center" style="display: inline;">Iron Layout</h5>
			...
			<div class="modal-header">
				<div class="input-group">
					<input id="searchIron" type="text" class="form-control"
						placeholder="Search Iron Layout"
						aria-label="Recipient's username" aria-describedby="basic-addon2">
					<div class="input-group-append">
						<span class="input-group-text"><i class="fa fa-search"></i></span>
					</div>
...
<script
	src="${pageContext.request.contextPath}/assets/js/production/iron_layout.js"></script>
