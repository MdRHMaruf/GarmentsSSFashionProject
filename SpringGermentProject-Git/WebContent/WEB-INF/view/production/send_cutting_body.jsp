...
<div class="page-wrapper">
	...
	<div class="card-box">
		<header class="d-flex justify-content-between">
			<h5 class="text-center" style="display: inline;">Send Cutting
				Body</h5>
		</header>
		<hr class="my-1">
		<div class="row">
			...
			<div class="col-md-5">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<button id="itemSearchBtn" type="button"
							class="btn btn-outline-dark btn-sm form-control-sm"
							data-toggle="modal" data-target="#sendCuttingBodyInfoList">
							<i class="fa fa-search">Send Body List</i>
						</button>
					</div>
				</div>
				<div class="row">
				...
				<table class="table table-hover table-bordered table-sm mb-0">
					<thead>
						<tr>
							...
							<th>Size Name</th>
							<th>Quantity</th>
							<th>Send <input type="checkbox" id="allCheck" onclick="setCheck()" /></th>
						</tr>
					</thead>
...
<div class="modal fade" id="sendCuttingBodyInfoList" tabindex="-1" role="dialog"
	aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
						 ...
						 <c:forEach items="${sendCuttingBodyInfoList}" var="list"
							...
							<tr>
								...
								<td><i class="fa fa-print" style="cursor:pointer;"
									onclick="printSendCuttingBody(${list.cuttingEntryId})">
								</i></td>
							</tr>
						</c:forEach> 
					</tbody>
...
<script
	src="${pageContext.request.contextPath}/assets/js/production/send-cutting-body.js"></script>
