...
<div class="page-wrapper">
	...
	<div class="card-box">
		<header class="">
			<h5 class="text-center" style="display: inline;">Poly Production</h5>
			...
			<button type="button" class="btn btn-outline-dark btn-sm"
				...
				<i class="fa fa-search"></i>Poly Production List
			</button>
		</header>
		<hr class="my-1">
		<div class="row">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					<table class="table table-hover table-bordered table-sm mb-0">
						...
						<tbody id="poList">
							<c:forEach items="${polyList}" var="list"
								varStatus="counter">
								<tr>
									<td>${counter.count}</td>
									<td id='buyerId${list.buyerId}'>${list.buyerName}</td>
									...
									<td><i class="fa fa-search"
										onclick="searchPolyDetails(${list.buyerId},${list.buyerorderId},${list.styleId},${list.itemId})">
									</i></td>
								</tr>
							</c:forEach>
						</tbody>
...
<script
	src="${pageContext.request.contextPath}/assets/js/production/poly_production.js"></script>
