...
<div class="page-wrapper">
	...
	<input type="hidden" id="itemAutoId" value="0">
		<input type="hidden" id="hid_buyerId" value="0">
			<input type="hidden" id="hid_buyerOrderId" value="0">
				<input type="hidden" id="hid_styleId" value="0">
					<input type="hidden" id="hid_itemId" value="0">

	<div class="card-box">
		<header class="d-flex justify-content-between">
			<h5 class="text-center" style="display: inline;">Cutting Information</h5>
			...
			<div class="col-md-10 mb-1 pr-1">
				<div class="row">
					...
					<div class="form-group col-md-2 mb-1"
						...
						<label for="purchaseOrder" class="col-form-label-sm mb-0 pb-0">Department Name:</label>
						<div class="row">
				...
				<div class="row">
					...
					<div class="form-group col-md-2 mb-1"
						...
						<label for="sample" class="col-form-label-sm mb-0 pb-0">Marking Layer</label>
						<div class="row">
								<input type="text" id="markingLayer" class="col-md-12 form-control-sm" />
						</div>
					</div>
										
					<div class="form-group col-md-2 mb-1"
						style="padding-left: 15px; padding-right: 16px;">
						<label for="sample" class="col-form-label-sm mb-0 pb-0">Marking Length</label>
						<div class="row">
								<input type="text" id="markingLength" class="col-md-12 form-control-sm" />
						</div>
					</div>					
					
					<div class="form-group col-md-2 mb-1"
						style="padding-left: 15px; padding-right: 16px;">
						<label for="sample" class="col-form-label-sm mb-0 pb-0">Marking Width</label>
						<div class="row">
								<input type="text" id="markingWidth" class="col-md-12 form-control-sm" />
						</div>
					</div>
						<div class="form-group col-md-2 mb-1"
						style=" padding-right: 30px;">
						<label for="sample" class="col-form-label-sm mb-0 pb-0">Before The Cut</label>
						<div class="row">
								<input type="text" id="beforeTheCut" class="col-md-12 form-control-sm" />
						</div>
					</div>					
		...
		<div class="row">
					...
					<div class="form-group col-md-5 mb-1" style="padding-left: 30px;padding-right: 10px;">
					...
					<div class="form-group col-md-3 mb-2"
						...
						<label for="sample" class="col-form-label-sm mb-0 pb-0">Total Pcs Cut On the Date</label>
						<div class="row">
								<input type="text" id="markingLayer" class="col-md-12 form-control-sm" />
						</div>
					</div>
