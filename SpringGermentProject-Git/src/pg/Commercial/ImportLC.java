...
public class ImportLC {
	...
	public String getImportLCType() {
		return importLCType;
	}
	public void setImportLCType(String importLCType) {
		this.importLCType = importLCType;
	}
	...
	public String getEditedItemList() {
		return editedItemList;
	}
	public void setEditedItemList(String editedItemList) {
