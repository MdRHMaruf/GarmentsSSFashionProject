...
public class FabricsTransferIn {
	String autoId;
	...
	public FabricsTransferIn() {}
	public FabricsTransferIn(String autoId, String transectionId, String transferDate, String transferFrom, String receiveFrom, String remarks, String userId) {
		super();
		this.autoId = autoId;
